...
function zeroBSCRM_translist_learn_menu(){
    ...
    if ( zeroBSCRM_isZBSAdminOrAdmin() ) {
        ...
        $filterStr .= '<a href="' . $settingLink . '" class="ui icon button right floated" type="button" title="'.__('Transaction settings','zero-bs-crm').'"><i class="cogs icon"></i></a>';
    }
...
function zeroBSCRM_invoicelist_learn_menu(){
    ...
    if ( zeroBSCRM_isZBSAdminOrAdmin() ) {
        ...
        $filterStr .= '<a href="' . $settingLink . '" class="ui icon button right floated" type="button" title="'.__('Invoices settings','zero-bs-crm').'"><i class="cogs icon"></i></a>';
    } 
