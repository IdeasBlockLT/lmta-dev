        ...
        #} ============   SORT   ==============
            ...
            if ($withLastLog){
                    ...
                    if (is_array($contactLogTypes)){
                        ...
                        $contactLogTypes = array_map(function($v) {
                            return "'" . esc_sql($v) . "'";
                        }, $contactLogTypes);
                        $contactLogTypesStr = implode(',', $contactLogTypes);
    ...
    private function tidy_contact($obj=false,$withCustomFields=false){
        ...
        global $zbs;
            ...
            */
            ...
            $res['lastupdated_date'] = (isset($obj->zbsc_lastupdated) && $obj->zbsc_lastupdated > 0) ? zeroBSCRM_date_i18n(-1,$obj->zbsc_lastupdated,false,true) : false;
            $res['lastcontacteduts'] = $obj->zbsc_lastcontacted; // this is the UTS (int14)
            $res['lastcontacted_date'] = (isset($obj->zbsc_lastcontacted) && $obj->zbsc_lastcontacted > 0) ? zeroBSCRM_date_i18n(-1,$obj->zbsc_lastcontacted,false,true) : false;
