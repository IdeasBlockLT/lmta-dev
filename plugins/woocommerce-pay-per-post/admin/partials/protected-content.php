<div class="wrap about-wrap full-width-layout">
    ...
    <p class="about-text"><?php _e( 'This section is under heavy development.  If you have any suggestions on what you would like to see here please reach out!', 'wc_pay_per_post' ); ?></p>
                ...
                <div id="post-body-content">
                    ...
                    <h3>Showing users that purchased <?php echo $data[$_GET['product_id']]['title']; ?></h3>
                        <table style="width:100%;" class="purchased-content-table">
                            ...
                            <tbody>
		                    <?php foreach($data[$_GET['product_id']]['users'] as $email): $user = get_user_by( 'email', $email ); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo get_edit_user_link($user->ID);?>"><?php echo $email; ?></a></td>
                                </tr>
		                    <?php endforeach; ?>
                            </tbody>
                        </table>
