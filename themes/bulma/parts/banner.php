    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-10 text-center" style="background-color: #5797fb00">
            <p class="d-inline-block align-center custom-banner <?= esc_html($args['size']) ?>"   style="background-color: #5797fb00">
                ...
                <strong class="custom-size-banner"><?php bloginfo('name') ?> <small id="tv" class="text-uppercase" style="color:"<?php echo($text_color); ?>"; display: table-caption"><?php bloginfo('description') ?></small></strong>
            </p>
        </div>
